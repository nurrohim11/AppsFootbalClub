...
class NextMatchAdapter(private val events:List<Events>, private  val listener: (Events) -> Unit) : RecyclerView.Adapter<NextMatchViewHolder>() {
...
class NextMatchViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    private val tvTime : TextView = view.find(tvTimeEvent)
